            ...
            <div className="w-full">
                <div className="flex justify-between gap-2">
                    <div>
                        ...
                        <h4 className="text-gray-400 text-sm -mt-1">@{authorProfile?.username}</h4>
                    </div>
                </div>
                
                <div>
                    <div className="bg-gray-200 border border-gray-300 rounded-md p-2">
                        <p>{text}</p>
                    </div>
                    <div className="text-xs text-gray-400 text-right">
                        {format(createdAt, 'yyyy-MM-ddd HH:mm:ss')}
                    </div>
                </div>
            </div>
        </div>
